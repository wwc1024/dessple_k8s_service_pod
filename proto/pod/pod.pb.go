...
var file_proto_pod_pod_proto_goTypes = []interface{}{
	...
	(*Response)(nil), // 3: pod.Response
	(*PodId)(nil),    // 4: pod.PodId
...
var file_proto_pod_pod_proto_depIdxs = []int32{
	...
	4, // 4: pod.Pod.DeletePod:input_type -> pod.PodId
	4, // 5: pod.Pod.FindPodByID:input_type -> pod.PodId
	0, // 6: pod.Pod.UpdatePod:input_type -> pod.PodInfo
	5, // 7: pod.Pod.FindAllPod:input_type -> pod.FindAll
	3, // 8: pod.Pod.AddPod:output_type -> pod.Response
	3, // 9: pod.Pod.DeletePod:output_type -> pod.Response
	0, // 10: pod.Pod.FindPodByID:output_type -> pod.PodInfo
	3, // 11: pod.Pod.UpdatePod:output_type -> pod.Response
